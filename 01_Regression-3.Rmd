...
Variability of residuals is much lower than variability of predictions.
...
Variability of residuals is much higher than variability of predictions.
...
\end{align*}
- \alert{Total sum of squares = Regression sum of squares +
...
\] 
- Expresses the proportion of variability on data is captured by their association with explanatory variable
...
- CWD basal area: Multiple R-Squared = 0.7159, i.e. 71.59\% of variability on CWD basal area is explained by tree density.
- Larches: Multiple R-Squared = 0.8836, i.e. 88.36\% of variability on tree length is explained by mineral composition of needles.
