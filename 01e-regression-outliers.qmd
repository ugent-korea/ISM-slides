...
## Extreme outcomes in analysis of larches?
...
- **Extreme Cook's distance**: exceeds the 50th percentile (median) of the $F_{p,n-p}$-distribution
...
#| fig-height: 4.5
#| fig-align: center
inter5 <- needles$phosphor * needles$residu
par(mfrow=c(1,2))
...
```{r}
needles2 <- needles[-1, ]
model_l6 <- lm(length ~ nitrogen * phosphor + potassium
               + phosphor * residu, data = needles2)
```
```{r echo=FALSE}
