...
Recall: loadings vectors are linear combinations of features, tell us how features contribute to variability in dataset.

![](./images/02b-pca-applications/first-two-pcs.png){fig-align=center height=50%}

For our example:

- Loadings vector 1: what does a typical spectrum look like?
- Loadings vector 2: where are typical differences between spectra located?
