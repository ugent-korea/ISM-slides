...
\begin{multline*}
  J(\theta) \approx 
    J(\theta_\text{best}) + \underbrace{\nabla J(\theta_\text{best})}_{= 0} \cdot (\theta - \theta_\text{best}) \\
    + \frac{1}{2} (\theta - \theta_\text{best})^T \cdot \nabla^2 J(\theta_\text{best}) \cdot (\theta - \theta_\text{best}).
\end{multline*}
...
\[
  \mathcal{I} = \frac{1}{\sigma^2} \sum_{i = 1}^N [\nabla f(x_i, \theta_\text{best})] \cdot [\nabla f(x_i, \theta_\text{best})]^T.
\]
