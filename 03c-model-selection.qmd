...
In effect, this is the bias-variance trade-off in disguise: SSR plays the role of bias, the complexity penalty the role of variance.
...
- The U-shape is the bias-variance trade-off in action: adding parameters helps until it starts to hurt
