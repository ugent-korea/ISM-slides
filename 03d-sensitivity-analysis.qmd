...
2. Relative sensitivity w.r.t. variable 
  $$
    \frac{\partial y_i(t)}{\partial \theta_j} \cdot \dfrac{1}{y_i}
  $$ 
...
$$R^2=\dfrac{\sum_{i=1}^n(\hat{y}_i-\overline{y})^2}{\sum_{i=1}^n(y_i-\overline{y})^2}$$
...
- Example of model with 3 parameters:
$$
