...
```{r include = FALSE}
CWD <- read.table("./datasets/christ.csv", header = T, sep = ",", dec = ".")
attach(CWD)
...
\centering
\includegraphics[width=0.30\textwidth]{pdf/riparian.png}
...
\centering
\includegraphics[height = 7.5 cm , width = 10cm]{pdf/spread.pdf}
